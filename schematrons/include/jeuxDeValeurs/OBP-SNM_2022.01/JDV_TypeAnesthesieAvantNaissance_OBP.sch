...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="JDV_TypeAnesthesieAvantNaissance_OBP" is-a="dansJeuDeValeurs">
    ...
    <param name="xpath_elt" value="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section/cda:component/cda:section/cda:entry/cda:procedure[cda:code/@code='OBS_029']/cda:code/cda:qualifier/cda:value"/>
