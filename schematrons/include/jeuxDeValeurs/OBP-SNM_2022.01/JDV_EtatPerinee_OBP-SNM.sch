...
-->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="JDV_EtatPerinee_OBP-SNM" is-a="dansJeuDeValeurs">
    <p>Conformité des demandes d'examen complémentaires</p>
    <param name="path_jdv" value="$JDV_EtatPerinee_OBP-SNM"/>
