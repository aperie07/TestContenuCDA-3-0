...
<!-- 
   JDV_UFCV_MatImpl_CARD-F-PRC-PSC.sch :
    Contenu :
    ...
    Historique :
        05/01/2023 : Création
-->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="JDV_UFCV_MatImpl_CARD-F-PRC-PSC" is-a="dansJeuDeValeurs">
    <p>Conformité CI-SIS du value du problème</p>
    <param name="path_jdv" value="$jdv_UFCV_MatImpl_CARD-F-PRC-PSC"/>
