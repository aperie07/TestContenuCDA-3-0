...
<!-- 
    ...
    04/11/2022 : Mise à jour suite à la migration
-->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="JDV_StaticSCEprocedures_OBP-SCE" is-a="dansJeuDeValeurs">
    <p>Conformité des demandes d'examen complémentaires</p>
    <param name="path_jdv" value="$jdv_StaticSCEprocedures_OBP-SCE"/>
