...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="S_BirthOrganizer_OBP">  
    ...
    <rule context='*[cda:templateId/@root="1.3.6.1.4.1.19376.1.5.3.1.4.13.5.2"]'>  
        ...
        <assert test="cda:component/cda:observation[cda:templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.4.13.5']/cda:code[@code='57071-3']">
            [S_BirthOrganizer_OBP] : L'entrée FR-Naissance doit contenir une entrée FR-Observation-sur-la-grossesse "Mode d'accouchement" (57071-3)
        </assert>
        ...
        <assert test="cda:component/cda:observation[cda:templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.4.13.5']/cda:code[@code='92276-5']">
            [S_BirthOrganizer_OBP] : L'entrée FR-Naissance doit contenir une entrée FR-Observation-sur-la-grossesse "Etat de l'enfant" (92276-5)
        </assert>
