...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="E_FR-Prelevement">
    ...
    <rule context="cda:procedure[./cda:templateId/@root='1.3.6.1.4.1.19376.1.3.1.2']">
        ...
        <assert test="
            (count(./cda:entryRelationship/cda:act/cda:code[@code = 'SPRECEIVE']/../cda:effectiveTime[@value]/../../../cda:templateId[@root='1.3.6.1.4.1.19376.1.3.1.2'])
            = 
            count((./cda:entryRelationship/cda:act/cda:code[@code = 'SPRECEIVE']/../../../cda:templateId[@root='1.3.6.1.4.1.19376.1.3.1.2'])))">
            [E_FR-Prelevement] Erreur de conformité :
