...
<!-- 
    Schématron du CS24 : CI-SIS_CSE-CS24_2022.01.sch
    ANS
    ...
    ......................................................................................................................................................               
-->
<schema xmlns="http://purl.oclc.org/dsdl/schematron" defaultPhase="CI-SIS_CSE-CS24_2022.01"
    xmlns:cda="urn:hl7-org:v3" queryBinding="xslt2"
    xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" schemaVersion="CI-SIS_CSE-CS24_2022.01.sch">
    <title>Vérification de conformité du document aux spécifications du modèle CSE-CS24_2022.01</title>
    ...
    <include href="include/specificationsVolets/CSE-CS24_2022.01/Entrees/E_abdomen_CSE-CS24.sch"/>
    <include href="include/specificationsVolets/CSE-CS24_2022.01/Entrees/E_codedSocialHistory_CSE-CS24.sch"/>
    <include href="include/specificationsVolets/CSE-CS24_2022.01/Entrees/E_ears_CSE-CS24.sch"/>
    <include href="include/specificationsVolets/CSE-CS24_2022.01/Entrees/E_eatingSleeping_CSE-CS24.sch"/>
    <include href="include/specificationsVolets/CSE-CS24_2022.01/Entrees/E_endocrine_CSE-CS24.sch"/>
    <include href="include/specificationsVolets/CSE-CS24_2022.01/Entrees/E_eyes_CSE-CS24.sch"/>
    <include href="include/specificationsVolets/CSE-CS24_2022.01/Entrees/E_generalApp_CSE-CS24.sch"/>
    <include href="include/specificationsVolets/CSE-CS24_2022.01/Entrees/E_genitalia_CSE-CS24.sch"/>
    <include href="include/specificationsVolets/CSE-CS24_2022.01/Entrees/E_heart_CSE-CS24.sch"/>
    <include href="include/specificationsVolets/CSE-CS24_2022.01/Entrees/E_historyOfPastIllness_CSE-CS24.sch"/>
    <include href="include/specificationsVolets/CSE-CS24_2022.01/Entrees/E_integumentary_CSE-CS24.sch"/>
    <include href="include/specificationsVolets/CSE-CS24_2022.01/Entrees/E_lymphatic_CSE-CS24.sch"/>
    <include href="include/specificationsVolets/CSE-CS24_2022.01/Entrees/E_musculo_CSE-CS24.sch"/>
    <include href="include/specificationsVolets/CSE-CS24_2022.01/Entrees/E_neurologic_CSE-CS24.sch"/>
    <include href="include/specificationsVolets/CSE-CS24_2022.01/Entrees/E_respiratory_CSE-CS24.sch"/>
    <include href="include/specificationsVolets/CSE-CS24_2022.01/Entrees/E_teeth_CSE-CS24.sch"/> 
    <include href="include/specificationsVolets/CSE-CS24_2022.01/Entrees/E_developpementPsychomoteur_CSE-CS24.sch"/>
    
    <!-- JDV -->    
    <include href="include/jeuxDeValeurs/CSE-CS24_2022.01/JDV_Activite-CISIS.sch"/>    
    <include href="include/jeuxDeValeurs/CSE-CS24_2022.01/JDV_CauseAccidentDom-CISIS.sch"/>
    <include href="include/jeuxDeValeurs/CSE-CS24_2022.01/JDV_NiveauEtude-CISIS.sch"/>
    <include href="include/jeuxDeValeurs/CSE-CS24_2022.01/JDV_Profession-CISIS.sch"/>
    <include href="include/jeuxDeValeurs/CSE-CS24_2022.01/JDV_TypeGarde-CISIS.sch"/>
    <include href="include/jeuxDeValeurs/CSE-CS24_2022.01/JDV_VaccinCSE24-CISIS.sch"/>
    
    <!-- ::::::::::::::::::::::::::::::::::::: -->
    <!--           Phase en vigueur            -->    
    <!-- ::::::::::::::::::::::::::::::::::::: -->
    <phase id="CI-SIS_CSE-CS24_2022.01">
    ...
    <pattern id="variables">
        ...
        <rule context='cda:ClinicalDocument/cda:component/cda:structuredBody'>
            ...
            <assert test='cda:component/cda:section/cda:templateId[@root = "1.3.6.1.4.1.19376.1.5.3.1.3.16.1"]'>
                [CI-SIS_CSE-CS24_2022.01.sch] Erreur de conformité : La section Habitus, Mode de vie (1.3.6.1.4.1.19376.1.5.3.1.3.16.1) est obligatoire.  
            </assert>
            ...
            <assert test='cda:component/cda:section/cda:templateId[@root = "1.3.6.1.4.1.19376.1.5.3.1.3.8"]'>
                [CI-SIS_CSE-CS24_2022.01.sch] Erreur de conformité : La section Antécédents médicaux (1.3.6.1.4.1.19376.1.5.3.1.3.8) est obligatoire.  
            </assert>
            ...
            <assert test='cda:component/cda:section/cda:templateId[@root = "1.3.6.1.4.1.19376.1.5.3.1.1.9.15.1"]'>
                [CI-SIS_CSE-CS24_2022.01.sch] Erreur de conformité : La section Examens physiques (1.3.6.1.4.1.19376.1.5.3.1.1.9.15.1) est obligatoire.  
            </assert>
            ...
            <assert test='cda:component/cda:section/cda:templateId[@root = "1.3.6.1.4.1.19376.1.7.3.1.1.13.3"]'>
                [CI-SIS_CSE-CS24_2022.01.sch] Erreur de conformité : La section Evaluation du statut fonctionnel de l'enfant (1.3.6.1.4.1.19376.1.7.3.1.1.13.3) est obligatoire.  
            </assert>
            
            <!-- Présence obligatoire de la section Allergies et hypersensibilités (1.3.6.1.4.1.19376.1.5.3.1.3.13) -->
            <assert test='cda:component/cda:section/cda:templateId[@root = "1.3.6.1.4.1.19376.1.5.3.1.3.13"]'>
                [CI-SIS_CSE-CS24_2022.01.sch] Erreur de conformité : La section Allergies et hypersensibilités (1.3.6.1.4.1.19376.1.5.3.1.3.13) est obligatoire.  
            </assert>
            ...
            <assert test='cda:component/cda:section/cda:templateId[@root = "1.3.6.1.4.1.19376.1.5.3.1.3.23"]'>
                [CI-SIS_CSE-CS24_2022.01.sch] Erreur de conformité : La section Vaccinations (1.3.6.1.4.1.19376.1.5.3.1.3.23) est obligatoire.  
            </assert>
            ...
            <assert test='cda:component/cda:section/cda:templateId[@root = "1.3.6.1.4.1.19376.1.5.3.1.1.13.2.5"]'>
                [CI-SIS_CSE-CS24_2022.01.sch] Erreur de conformité : La section Évaluation et plan (non codé) (1.3.6.1.4.1.19376.1.5.3.1.1.13.2.5) est obligatoire.  
            </assert>
            ...
            <assert test='cda:component/cda:section/cda:templateId[@root = "1.3.6.1.4.1.19376.1.5.3.1.3.36"]'>
                [CI-SIS_CSE-CS24_2022.01.sch] Erreur de conformité : La section Plan de soins (1.3.6.1.4.1.19376.1.5.3.1.3.36) est obligatoire.  
            </assert>
