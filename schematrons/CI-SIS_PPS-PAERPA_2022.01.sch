    ...
    <pattern id="variables">
        ...
        <rule context="cda:ClinicalDocument">
            <assert test="cda:templateId[@root='1.2.250.1.213.1.1.1.20']"> 
                [CI-SIS_PPS-PAERPA_2022.01] Le templateId de conformité au modèle PPS-PAERPA_2022.01 (1.2.250.1.213.1.1.1.20) doit être présent.
            </assert>
            <assert test="./cda:code[@code='18776-5' and @codeSystem='2.16.840.1.113883.6.1']"> 
                [CI-SIS_PPS-PAERPA_2022.01] L'élément code doit avoir @code ="18776-5" et @codeSystem = "2.16.840.1.113883.6.1"/>. 
            </assert>
        </rule>        
