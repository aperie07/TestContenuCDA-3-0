...
<!-- 
   Schématron CI-SIS_DLU-EHPAD-FLUDR_2022.01.sch
...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" 
        ...
        queryBinding="xslt2" schemaVersion="CI-SIS_DLU-EHPAD-FLUDR_2022.01.sch">
    
        <title>Rapport de conformité du document aux spécifications du volet DLU-EHPAD-FLUDR_2022.01</title>
        ...
        <include href="include/jeuxDeValeurs/DLU-EHPAD-FLUDR_2022.01/JDV_CheckListDLU-FLUDR.sch"/>
        <include href="include/jeuxDeValeurs/DLU-EHPAD-FLUDR_2022.01/JDV_ProtheseObjetPersonnel-CISIS.sch"/>
        
        <!-- Schématron Entete spécifique au DLU-FLUDR -->        
        <include href="include/specificationsVolets/DLU-EHPAD-FLUDR_2022.01/Entete/Entete_DLU-FLUDR.sch"/>
        
        <!-- Schématron Section spécifique au DLU-FLUDR -->        
        <include href="include/specificationsVolets/DLU-EHPAD-FLUDR_2022.01/Sections/S_ResultatsEvenements_DLU-FLUDR.sch"/>
        
        <phase id="CI-SIS_DLU-EHPAD-FLUDR_2022.01">
        ...
        <pattern id="variables">
                ...
                <rule context="cda:ClinicalDocument">
                        <assert test="cda:templateId[@root='1.2.250.1.213.1.1.1.24']"> 
                                [CI-SIS_DLU-EHPAD-FLUDR_2022.01] Le templateId "1.2.250.1.213.1.1.1.24" (Conformité au modèle DLU-FLUDR du CI-SIS) doit être présent.
                        </assert>
                        <assert test="./cda:code[@code='34133-9' and @codeSystem='2.16.840.1.113883.6.1']"> 
                                [CI-SIS_DLU-EHPAD-FLUDR_2022.01] L'élément code doit avoir @code ="34133-9" et @codeSystem = "2.16.840.1.113883.6.1"/>. 
                        </assert>
                        ...
                        <assert test="count(cda:component/cda:structuredBody/cda:component/cda:section/cda:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.3.7'])=1"> 
                                [CI-SIS_DLU-EHPAD-FLUDR_2022.01] La section "Diagnostic de sortie episode de soins (structurée)" doit être présente une fois. Cardinalité [1..1].
                        </assert>
                        <assert test="count(cda:component/cda:structuredBody/cda:component/cda:section/cda:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.3.22'])=1"> 
                                [CI-SIS_DLU-EHPAD-FLUDR_2022.01] La section "Traitements-a-la-sortie (structurée)" doit être présente une fois. Cardinalité [1..1].
                        </assert>
                        <assert test="count(cda:component/cda:structuredBody/cda:component/cda:section/cda:templateId[@root='1.2.250.1.213.1.1.2.53'])=1"> 
                                [CI-SIS_DLU-EHPAD-FLUDR_2022.01] La section "Protheses et objets personnels" doit être présente une fois. Cardinalité [1..1].
                        </assert>
                        <assert test="count(cda:component/cda:structuredBody/cda:component/cda:section/cda:templateId[@root='1.2.250.1.213.1.1.2.37'])=1"> 
                                [CI-SIS_DLU-EHPAD-FLUDR_2022.01] La section "Documents ajoutés" doit être présente une fois. Cardinalité [1..1].
                        </assert>
                        <assert test="count(cda:component/cda:structuredBody/cda:component/cda:section/cda:templateId[@root='1.3.6.1.4.1.19376.1.4.1.2.16'])&lt; 2"> 
                                [CI-SIS_DLU-EHPAD-FLUDR_2022.01] La section "Commentaire non codé" ne peut être présente qu'une fois. Cardinalité [0..1].
                        </assert>
