...
<!-- Schématron CI-SIS_OPH-BRE_2022.01
        Vérification de la conformité du document au modèle OPH-BRE_2022.01   
...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" defaultPhase="OPH-BRE"
        ...
        xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" schemaVersion="CI-SIS_OPH-BRE_2022.01.sch">

        <title>Vérification de la conformité du document au modèle OPH-BRE_2022.01</title>
        ...
        <include href="include/jeuxDeValeurs/OPH-BRE_2022.01/JDV_MotifConsultationOphtalmologique-CISIS.sch"/>
        <include href="include/jeuxDeValeurs/OPH-BRE_2022.01/JDV_MotifConsultationOphtalmologiqueEntete-CISIS.sch"/>
        <include href="include/jeuxDeValeurs/OPH-BRE_2022.01/JDV_OrientationBaseDuPrisme-CISIS.sch"/>        
        <include href="include/jeuxDeValeurs/OPH-BRE_2022.01/JDV_OeilExamine-CISIS.sch"/>
        <include href="include/jeuxDeValeurs/OPH-BRE_2022.01/JDV_TypeDeVerresPrescrits-CISIS.sch"/>
        <include href="include/jeuxDeValeurs/OPH-BRE_2022.01/JDV_TypeDeLentilles-CISIS.sch"/>
        <include href="include/jeuxDeValeurs/OPH-BRE_2022.01/JDV_AdditionGrandeur-CISIS.sch"/>
        <include href="include/jeuxDeValeurs/OPH-BRE_2022.01/JDV_TypeDePrisme-CISIS.sch"/>
        <include href="include/jeuxDeValeurs/OPH-BRE_2022.01/JDV_Lateralite-CISIS.sch"/>
        <include href="include/jeuxDeValeurs/OPH-BRE_2022.01/JDV_TypeDeMesureAcuiteVisuelle-CISIS.sch"/>
        <include href="include/jeuxDeValeurs/OPH-BRE_2022.01/JDV_TypeDeMesureDeRefraction-CISIS.sch"/>
        <include href="include/jeuxDeValeurs/OPH-BRE_2022.01/JDV_TypeDeMesureDispositifOculaire-CISIS.sch"/>
        <include href="include/jeuxDeValeurs/OPH-BRE_2022.01/JDV_MesureVerrePrescrit-CISIS.sch"/>
        <include href="include/jeuxDeValeurs/OPH-BRE_2022.01/JDV_MesureTypeVerrePrescrit-CISIS.sch"/>
        <include href="include/jeuxDeValeurs/OPH-BRE_2022.01/JDV_MesureVerreDelivre-CISIS.sch"/>
        ...
        <pattern id="variables">      
                ...
                <rule context="cda:ClinicalDocument/cda:component/cda:structuredBody">
                        ...
                        <assert test="cda:component/cda:section/cda:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.3.1']"> 
                                [OPH-BRE_2022.01] Erreur de conformité : La section "FR-Raison-de-la-recommandation" (1.3.6.1.4.1.19376.1.5.3.1.3.1) doit être présente.
                        </assert>                        
                        ...
                        <assert test="cda:component/cda:section/cda:templateId[@root='1.3.6.1.4.1.19376.1.12.1.2.5']"> 
                                [OPH-BRE_2022.01] Erreur de conformité : La section "FR-Examen-physique-oculaire" (1.3.6.1.4.1.19376.1.12.1.2.5) doit être présente.
                        </assert>
                        ...
                        <assert test="cda:component/cda:section/cda:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.1.13.2.1']"> 
                                [OPH-BRE_2022.01] Erreur de conformité : La section "FR-Principal-motif-non-code" (1.3.6.1.4.1.19376.1.5.3.1.1.13.2.1) doit être présente.
                        </assert>
                        ...
                        <assert test="cda:component/cda:section/cda:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.3.4']"> 
                                [OPH-BRE_2022.01] Erreur de conformité : La section "FR-Histoire-de-la-maladie-non-code" (1.3.6.1.4.1.19376.1.5.3.1.3.4) doit être présente.
                        </assert>
                        ...
                        <assert test="cda:component/cda:section/cda:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.1.13.2.5']"> 
                                [OPH-BRE_2022.01] Erreur de conformité : La section "FR-Evaluation-et-plan-non-code" (1.3.6.1.4.1.19376.1.5.3.1.1.13.2.5) doit être présente.
                        </assert>
