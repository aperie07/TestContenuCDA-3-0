...
<!-- 
    abstracFunctionCode.sch :
    Contenu :
        Contrôle de l'élement functionCode par rapport aux JDV définis dans CI-SIS_StructurationMinimale.sch
...
-->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="abstractFunctionCode" abstract="true" 
    xmlns:svs="urn:ihe:iti:svs:2008">
    <p>Contrôle de l'appartenance du functionCode à un jeu de valeurs du CI-SIS</p>
    <rule context="$xpath_elt">
        ...
        <assert test="(
            ...
            [abstractFunctionCode] L'élément "<value-of select="$vue_elt"/>" doit avoir ses attributs 
            @code et @codeSystem renseignés, ou un xsi:type différent de CD ou CE.
        </assert>
        ...
        <assert test="((@xsi:type and not(@xsi:type = 'CD') and not(@xsi:type = 'CE')) or 
            ...
            [abstractFunctionCode] L'élément <value-of select="$vue_elt"/>
