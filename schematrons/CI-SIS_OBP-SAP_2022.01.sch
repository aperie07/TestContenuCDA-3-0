...
<!-- 
    ...
    Historique :
        ...
        14/04/2022 : Modification pour nouvelle version 2022.01
                     Migration des terminologies et JDV en SNOMED-CT
        
-->
<schema xmlns="http://purl.oclc.org/dsdl/schematron" defaultPhase="CI-SIS_OBP-SAP_2022.01"
    xmlns:cda="urn:hl7-org:v3" queryBinding="xslt2"
    xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" schemaVersion="CI-SIS_OBP-SAP_2022.01.sch">
    <title>Vérification de la conformité au modèle OBP-SAP_2022.01</title>
   ...
   <!-- Abstract patterns -->    
    ...
    <!--Entete-->    
    <include href="include/specificationsVolets/OBP-SAP_2022.01/Entete/Entete_OBP.sch"/>
    
    <!-- Sections obligatoires -->    
    <include href="include/specificationsVolets/OBP-SAP_2022.01/Sections/S_BirthOrganizer_OBP.sch"/>
    <include href="include/specificationsVolets/OBP-SAP_2022.01/Sections/S_activeProblem_OBP.sch"/>
    <include href="include/specificationsVolets/OBP-SAP_2022.01/Sections/S_codedDetailedPhysicalExamination_OBP.sch"/>
    <include href="include/specificationsVolets/OBP-SAP_2022.01/Sections/S_codedSocialHistory_OBP.sch"/>
    <include href="include/specificationsVolets/OBP-SAP_2022.01/Sections/S_patientEducation_OBP.sch"/>
    <include href="include/specificationsVolets/OBP-SAP_2022.01/Sections/S_pregnancyHistoryOrganizer_OBP.sch"/>
    <include href="include/specificationsVolets/OBP-SAP_2022.01/Sections/S_procedureEntry_OBP.sch"/>

    <!-- JDV -->    
    <include href="include/jeuxDeValeurs/OBP-SAP_2022.01/JDV_AllergyAndIntoleranceCodes_OBP.sch"/>
    <include href="include/jeuxDeValeurs/OBP-SAP_2022.01/JDV_IssueGrossesse_OBP.sch"/>
    <include href="include/jeuxDeValeurs/OBP-SAP_2022.01/JDV_StaticSAPActiveProblem_OBP.sch"/>
    <include href="include/jeuxDeValeurs/OBP-SAP_2022.01/JDV_EtatPerinee_OBP.sch"/>
    <include href="include/jeuxDeValeurs/OBP-SAP_2022.01/JDV_IssueAccouchement_OBP.sch"/>
    <include href="include/jeuxDeValeurs/OBP-SAP_2022.01/JDV_EtatNaissance_OBP.sch"/>
    <include href="include/jeuxDeValeurs/OBP-SAP_2022.01/JDV_TranfertMutation_OBP.sch"/>
    <include href="include/jeuxDeValeurs/OBP-SAP_2022.01/JDV_GroupeRhesus_OBP.sch"/>
    <include href="include/jeuxDeValeurs/OBP-SAP_2022.01/JDV_AnomalieCroissance_OBP.sch"/>
    <include href="include/jeuxDeValeurs/OBP-SAP_2022.01/JDV_AnomalieConstitutionnelle_OBP.sch"/>
    <include href="include/jeuxDeValeurs/OBP-SAP_2022.01/JDV_HTAGravidique_OBP.sch"/>
    <include href="include/jeuxDeValeurs/OBP-SAP_2022.01/JDV_DiabeteGrossesse_OBP.sch"/>
    <include href="include/jeuxDeValeurs/OBP-SAP_2022.01/JDV_InfectUrinaire_OBP.sch"/>
    <include href="include/jeuxDeValeurs/OBP-SAP_2022.01/JDV_InfectCervicoVaginale_OBP.sch"/>
    <include href="include/jeuxDeValeurs/OBP-SAP_2022.01/JDV_TrimestreGrossesse_OBP.sch"/>
    <include href="include/jeuxDeValeurs/OBP-SAP_2022.01/JDV_AntecedentsObstetricaux_OBP.sch"/>
    <include href="include/jeuxDeValeurs/OBP-SAP_2022.01/JDV_ObservationEnfant_OBP.sch"/>
        
    <!-- ::::::::::::::::::::::::::::::::::::: -->
    <!--           Phase en vigueur            -->    
    <!-- ::::::::::::::::::::::::::::::::::::: -->
    
    <phase id="CI-SIS_OBP-SAP_2022.01">
    ...
    <pattern id="variables">
        ...
        <rule context="cda:ClinicalDocument">
            <assert test="cda:templateId[@root='1.2.250.1.213.1.1.1.12.1']"> 
                [CI-SIS_OBP-SAP_2022.01] Le template du modèle OBP-SAP (1.2.250.1.213.1.1.1.12.1) doit être présent.
            </assert>
            
            <assert test="./cda:code[@code='34133-9' and @codeSystem='2.16.840.1.113883.6.1']"> 
                [CI-SIS_OBP-SAP_2022.01] L'élément code doit avoir @code ="34133-9" et @codeSystem = "2.16.840.1.113883.6.1"/>. 
            </assert>
        </rule>
