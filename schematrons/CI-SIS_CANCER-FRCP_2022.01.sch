...
<!-- 
    CI-SIS_CANCER-FRCP_2022.01.sch
    ......................................................................................................................................................
    Auteur : ANS 
...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" schemaVersion="CI-SIS_CANCER-FRCP_2022.01.sch">
    <title>Rapport de conformité du document aux spécifications du modèle FRCP_2022.01 du CI-SIS</title>
    ...
    <include href="include/jeuxDeValeurs/CANCER-FRCP_2022.01/JDV_StatutCasPresente-CISIS.sch"/>
    <include href="include/jeuxDeValeurs/CANCER-FRCP_2022.01/JDV_StatutDoc-CISIS.sch"/>
    <include href="include/jeuxDeValeurs/CANCER-FRCP_2022.01/JDV_StatutQuorum-CISIS.sch"/>
    <include href="include/jeuxDeValeurs/CANCER-FRCP_2022.01/JDV_TraitementSoins-FRCP-CISIS.sch"/>
    <include href="include/jeuxDeValeurs/CANCER-FRCP_2022.01/JDV_Tumeur-CISIS.sch"/>
    <include href="include/jeuxDeValeurs/CANCER-FRCP_2022.01/JDV_TypeTraitement-FRCP-CISIS.sch"/>
    <include href="include/jeuxDeValeurs/CANCER-FRCP_2022.01/JDV_Morphologie-CISIS.sch"/>
    
    <include href="include/specificationsVolets/CANCER-FRCP_2022.01/Entete/Entete_FRCP.sch"/>
    <include href="include/specificationsVolets/CANCER-FRCP_2022.01/Sections/S_cancerDiagnosis_FRCP.sch"/>
    ...
    <phase id="CI-SIS_CANCER-FRCP_2022.01">
    ...
    <pattern id="variables">
        ...
        <rule context='*[cda:templateId/@root="1.2.250.1.213.1.1.1.8"]'>
            ...
            <assert test='.//cda:templateId[@root = "1.3.6.1.4.1.19376.1.5.3.1.3.2"]'>
                [CI-SIS_CANCER-FRCP_2022.01] : Erreur de conformité : La section FR-Raison-de-la-recommandation doit être présente dans le document.
            </assert> 
            <assert test='.//cda:templateId[@root = "1.3.6.1.4.1.19376.1.5.3.1.1.21.2.9"]'>
                [CI-SIS_CANCER-FRCP_2022.01] : Erreur de conformité : La section FR-Resultats-evenements doit être présente dans le document.
            </assert> 
            <assert test='.//cda:templateId[@root = "1.3.6.1.4.1.19376.1.7.3.1.3.14.1"]'>
                [CI-SIS_CANCER-FRCP_2022.01] : Erreur de conformité : La section FR-Diagnostic-du-cancer doit être présente dans le document.
            </assert>
            <assert test='.//cda:templateId[@root = "1.2.250.1.213.1.1.2.25"]'>
                [CI-SIS_CANCER-FRCP_2022.01] : Erreur de conformité : La section FR-Note-de-progression doit être présente dans le document.
            </assert>
            <assert test='.//cda:templateId[@root = "1.3.6.1.4.1.19376.1.5.3.1.3.4"]'>
                [CI-SIS_CANCER-FRCP_2022.01] : Erreur de conformité : La section FR-Histoire-de-la-maladie-non-code doit être présente dans le document.
            </assert>
            ...
            <assert test='.//cda:templateId[@root = "1.2.250.1.213.1.1.2.33"]'>
                [CI-SIS_CANCER-FRCP_2022.01] : Erreur de conformité : La section FR-Statut-dossier-RCP doit être présente dans le document.
            </assert> 
            <assert test='.//cda:templateId[@root = "1.2.250.1.213.1.1.2.35"]'>
                [CI-SIS_CANCER-FRCP_2022.01] : Erreur de conformité : La section FR-Statut-du-document doit être présente dans le document.
            </assert>
            <assert test="./cda:code[@code='34794-8' and @codeSystem='2.16.840.1.113883.6.1']"> 
                [CI-SIS_CANCER-FRCP_2022.01] : Erreur de conformité : L'élément "code" de la FRCP doit avoir les attributs @code ="34794-8" et @codeSystem = "2.16.840.1.113883.6.1". 
            </assert>
